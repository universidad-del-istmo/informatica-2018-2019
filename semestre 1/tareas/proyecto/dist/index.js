...
var joakin$elm_canvas$Canvas$lineTo = F3(
	function (x, y, cmds) {
		return A2(
...
var joakin$elm_canvas$Canvas$moveTo = F3(
	function (x, y, cmds) {
		return A2(
			joakin$elm_canvas$Canvas$addTo,
			cmds,
...
var author$project$Main$dibujar = F2(
	function (triangulo, context) {
		var acc = F3(
			function (_n2, _n3, s) {
				var x0 = _n2.a;
				var y0 = _n2.b;
				...
				return A3(
					...
					x,
					y,
					A3(joakin$elm_canvas$Canvas$moveTo, x0, y0, s));
			});
		if (triangulo.b) {
			var _n1 = triangulo.a;
			var x0 = _n1.a;
			...
			return A3(
				...
				A3(
					...
					acc(
						_Utils_Tuple2(x0, y0)),
					A3(joakin$elm_canvas$Canvas$moveTo, x0, y0, context),
					xs));
		} else {
			return context;
		}
...
var author$project$Main$fractal = _List_fromArray(
	[
		...
		_Utils_Tuple2(250, 250),
		_Utils_Tuple2(200, 400),
		_Utils_Tuple2(300, 500)
	]);
var author$project$Main$koch = function (reps) {
	return author$project$Main$fractal;
};
...
var joakin$elm_canvas$Canvas$stroke = function (cmds) {
	return A2(
		joakin$elm_canvas$Canvas$addTo,
		cmds,
...
var author$project$Main$view = function () {
	...
	return A4(
		...
		_List_fromArray(
			[
				A2(elm$html$Html$Attributes$style, 'border', '5px solid yellow')
			]),
